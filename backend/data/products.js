const products = [
  // Living Room
  {
    ...
    brand: 'BIGDON Home', description: 'Elegant modern velvet sofa with pristine cushioning and durable wooden frame.'
  },
  {
    ...
    brand: 'BIGDON Home', description: 'Sleek metal and glass coffee table.'
  },
  {
    ...
    brand: 'BIGDON Home', description: 'Large cozy L-shaped sectional couch for spacious living areas.'
  },
  {
    ...
    brand: 'BIGDON Home', description: 'A comfortable accent chair perfectly suited for reading.'
  },
  {
    ...
    brand: 'BIGDON Home', description: 'Solid wood TV stand with rustic metal accents.'
  },
  ...
  },
  {
    ...
    brand: 'BIGDON Coffee', description: 'Barista-level espresso machine with integrated grinder.'
  },
  {
  ...
  // Bedroom
  {
    ...
    brand: 'BIGDON Sleep', description: 'Ultra comfort cooling gel memory foam mattress.'
  },
  {
    ...
    brand: 'BIGDON Sleep', description: 'Solid walnut wood bed frame with upholstered headboard.'
  },
  {
    ...
    brand: 'BIGDON Sleep', description: 'Set of two matching mid-century nightstands.'
  },
  {
    ...
    brand: 'BIGDON Sleep', description: 'Spacious sliding door wardrobe with integrated LED lighting.'
  },
  {
    ...
    brand: 'BIGDON Sleep', description: '100% Egyptian cotton high-thread-count bedding set.'
  },
  ...
  // Office
  {
    ...
    brand: 'BIGDON Work', description: 'Fully adjustable ergonomic chair designed for extreme 8+ hours productivity.'
  },
  {
    ...
    brand: 'BIGDON Work', description: 'Dual-motor adjustable height standing desk with premium bamboo top.'
  },
  {
  ...
  },
  {
    ...
    brand: 'BIGDON Work', description: 'Clean white metal 3-drawer filing cabinet with lock.'
  },
  {
    ...
    brand: 'BIGDON Light', description: 'Adjustable LED desk lamp featuring wireless phone charging base.'
  }
];
